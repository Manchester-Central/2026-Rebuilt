...
public class MultiplayerPathPlannerTrajectoryState implements Interpolatable<MultiplayerPathPlannerTrajectoryState> {
   ...
   */
  public MultiplayerPathPlannerTrajectoryState interpolate(MultiplayerPathPlannerTrajectoryState endVal, double t) {
    var lerpedState = new MultiplayerPathPlannerTrajectoryState();
   ...
   */
  public MultiplayerPathPlannerTrajectoryState reverse() {
    var reversed = new MultiplayerPathPlannerTrajectoryState();
   ...
   */
  public MultiplayerPathPlannerTrajectoryState flip() {
    var flipped = new MultiplayerPathPlannerTrajectoryState();
   ...
   */
  public MultiplayerPathPlannerTrajectoryState copyWithTime(double time) {
    MultiplayerPathPlannerTrajectoryState copy = new MultiplayerPathPlannerTrajectoryState();
