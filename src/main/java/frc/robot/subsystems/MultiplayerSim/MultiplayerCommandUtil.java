...
public class MultiplayerCommandUtil {
   ...
   */
  public Command commandFromJson(
  ...
  private Command waitCommandFromData(JSONObject dataJson) {
    try {
  ...
  private Command namedCommandFromData(JSONObject dataJson) {
  ...
  private Command parallelGroupFromData(
      JSONObject dataJson, boolean loadChoreoPaths, boolean mirror)
      throws IOException, ParseException {
  ...
  private Command raceGroupFromData(
      JSONObject dataJson, boolean loadChoreoPaths, boolean mirror)
      throws IOException, ParseException {
  ...
  private Command deadlineGroupFromData(
      JSONObject dataJson, boolean loadChoreoPaths, boolean mirror)
      throws IOException, ParseException {
