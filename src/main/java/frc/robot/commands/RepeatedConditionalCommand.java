 ...
 */
public class RepeatedConditionalCommand extends Command {
  ...
  /**
   * Creates a new John's Contingency. (Lucas tested AND Colin Approved!)
   *
  ...
  public RepeatedConditionalCommand(Command onTrue, Command onFalse, BooleanSupplier condition) {
